...
//            + "<input key=\"bbc3da0b-09ee-4ed7-90b4-97ba106f872a\" number=\"3\" type=\"Virtual\" title=\"PTZ - C1-TOTAAL\" shortTitle=\"CAM1\" state=\"Paused\" position=\"0\" duration=\"0\" loop=\"False\">PTZ - C1-TOTAAL</input>"
//            + "<input key=\"bbc3da0b-09ee-4ed7-90b4-97ba106f872a\" number=\"3\" type=\"Virtual\" title=\"PTZ - C1-TOTAAL\" shortTitle=\"Cam1\" state=\"Paused\" position=\"0\" duration=\"0\" loop=\"False\">PTZ - C1-TOTAAL</input>"
...
//            + "</inputs></vmix>";
    ...
    public List<String> importCameras() {
        String xmlResponse = vmRequest.getCamsFromVmix();
